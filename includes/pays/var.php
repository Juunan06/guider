<section class="container-fluid">
	...
	<section class="presentCountry">
		...
		<p>
			<strong>L</strong>es grands espaces sauvages aux pentes boisées alternent avec plateaux arides. C'est le pays des clues et des villages belvédères vivant encore au rythme ancestral de l'élevage des moutons. Laissez-vous charmer par les villages de caractère.<br />Notre sélection de villages incontournables : <i>Roquesteron, Tourette du château, Gilette, Sigale</i>
		</p>
	</section>
	<!-- Carousel Fade -->
