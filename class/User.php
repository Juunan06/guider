...
class User
{
	...
	public function add($bdd){
		...
		$addUser = $bdd->prepare('INSERT INTO `users`(`users_first`, `users_last`, `users_phone`, `users_email`, `users_pwd`, `users_rank`) VALUES ( :first, :last, :phone, :mail, :pass, :rank)');
		...
		$addUser->bindValue(':mail', $this->getMail(), PDO::PARAM_STR);
