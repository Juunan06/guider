					...
					<div class="col-xl-12" id="registerFormL">
						<form class="form-horizontal" action="secure.php" method="POST">
							...
							<div class="form-group col-xl-8">					
								...
								<input class="col-xl-12" type="text" id="firstName" name="users_last" placeholder="votre nom">

							</div>  
							<div class="form-group col-xl-8">
								<label for="lastName" class="control-label col-xl-12">Prénom</label>
								<input class="col-xl-12" type="text" id="lastName" name="users_first" placeholder="votre prénom">

							</div> 
							<div class="form-group col-xl-8">
								<label for="phone" class="control-label col-xl-12">Téléphone</label>
								<input class="col-xl-12" type="text" id="phone" name="users_phone" placeholder="votre téléphone">

							</div>
							<div class="form-group col-xl-8">
								<label for="email" class="control-label col-xl-12">E-mail</label>
								<input class="col-xl-12" type="email" id="email" name="users_email" placeholder="votre email">

							</div> 
							<div class="form-group col-xl-8">
								<label for="pass" class="control-label col-xl-12">Mot de passe</label>
								<input class="col-xl-12" type="password" id="pass" name="users_pwd" placeholder="votre mot de passe">
