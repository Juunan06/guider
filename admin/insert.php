...
if(!empty($_POST))
{
    ...
    $imagePath = '../pays/images/' . basename($image);
    ...
    {
        // $db = Database::connect();
        $statement = $db->prepare("INSERT INTO guides (guide_first,guide_last,guide_pays,commune,langue,theme,prestation,photo) values (?,?,?,?,?,?,?,?)");
